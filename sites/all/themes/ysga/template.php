 ...
 *
 */
function ysga_preprocess_page(&$variables) {
  // Removes title for 'About Us page'
 ...
 */
function ysga_preprocess_html(&$variables) {
  $meta_charset = array(
    '#tag' => 'meta',
    '#attributes' => array(
      'charset' => 'utf-8',
 ...
 */
function ysga_html_head_alter(&$head_elements) {
...
function ysga_preprocess_node(&$vars) {
  // Add a striping class.
  $vars['classes_array'][] = 'node-' . $vars['zebra'];
}

function ysga_preprocess_block(&$vars, $hook) {
  // Add a striping class.
